      ...
      <div className="max-w-7xl mx-auto px-4 xl:px-16 lg:py-20 sm:py-16 py-8">
        <div className="flex flex-col gap-8 md:gap-12 items-center justify-center w-full">
          ...
          <div className="flex flex-col gap-4 justify-center items-center">
            ...
            {/* Heading */}
            <div className="max-w-[12rem] sm:max-w-md mx-auto text-center">
                ...
                >
                  ...
                  {isFeatured && (
                    <div className="absolute -inset-0.5 rounded-2xl overflow-hidden">
                      ...
                      <div
                        className="absolute -inset-full blur-[2px] animate-spin [animation-duration:2s]"
                        style={{
                          backgroundImage:
                            "conic-gradient(from 0deg, #3b82f6, #ef4444, #2dd4bf)",
                        }}
                      />
                    ...
                    <CardHeader className="p-0">
                      <div className="flex flex-col gap-3 self-stretch">
                        <div className="flex items-center justify-between">
                          ...
                          {isFeatured && (
                            <Badge className="py-1 px-3 text-sm font-medium leading-5 w-fit h-7 flex items-center gap-1.5 [&>svg]:!w-4 [&>svg]:!h-4">
                              <Flame className="w-4 h-4" /> Recommend
                            </Badge>
                          )}
                        </div>
